...
This guide provides the required steps to implement a Compliance Policy on Intune to report a device as non-compliant if Huntress is not installed or it's services stop running.
